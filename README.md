...
### 🗺️ Live Webapp — Interactive Crisis Map & Dashboard Demo
...
| **Top Crisis Type** | earthquake (21 events) |

*🤖 Auto-updated daily by GitHub Actions — [View latest report](data/daily_report_2026-08-02.json)*
